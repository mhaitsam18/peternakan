                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form action="../koneksi.php?login_pembeli" method="post">
                                            ...
                                            <div class="form-group">
                                                <div class="custom-control custom-checkbox">
                                                    ...
                                                    <label class="custom-control-label" for="rememberPasswordCheck">Ingat Kata Sandi</label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-footer text-center">
                                        <div class="small"><a href="registrasi.php">Butuh Akun? Daftar!</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
